...
* La acción “⚙️ Configuración…” abre un diálogo tabulado que permite editar `config_monitor.json` sin salir de la bandeja: se pueden ajustar el modo de trabajo, definir carpetas de monitoreo y respaldo, elegir el modo/momento de comparación, configurar intervalos independientes para expedientes y entradas, personalizar reintentos y preferencias de notificación. Al guardar se preservan claves personalizadas del JSON, se persiste con `guardar_config_monitor`, se recarga el resultado y se reinician tooltips/temporizadores para aplicar los cambios al instante.【F:Sistema_v4/monitor/monitor_entradas_expedientes_v4.py†L190-L699】【F:Sistema_v4/monitor/monitor_entradas_expedientes_v4.py†L1799-L1828】【F:Sistema_v4/monitor/configuracion_modo.py†L16-L71】
...
`ConfiguracionDialog` agrupa los parámetros en pestañas (general, intervalos, filtro, reintentos, respaldo y notificaciones), normaliza los datos ingresados y construye un diccionario compatible con `config_monitor.json`. El diálogo reutiliza `guardar_config_monitor` para persistir los cambios y la bandeja recarga la configuración resultante para recalcular rutas, reintentos y tooltips.【F:Sistema_v4/monitor/monitor_entradas_expedientes_v4.py†L190-L699】【F:Sistema_v4/monitor/monitor_entradas_expedientes_v4.py†L1799-L1828】
