...
async def probar_extraccion_completa():
    ...
    async with async_playwright() as p:
        ...
        print("🔁 Iniciando extracción paginada de actuaciones...")
        await obtener_actuaciones_todas_paginas_async(page_expediente, expediente_datos)

        await browser.close()

if __name__ == "__main__":
    asyncio.run(probar_extraccion_completa())